    ...
    function () {
      async function getMovies() {
        try {
          ...
          if (data.Response === "False") throw new Error("🤦‍♂️ Data Not Found");
...
function MovieDetails({ selectedID, onCloseMovie, addMovieWatched, watched }) {
